...
exports.checkUserAnswered = (req, res) => {
    ...
    db_1.connection.query(`SELECT language FROM profiles WHERE id=${verify.id}`, (err, lang) => {
        ...
        // jika bahasa inggris
        if (language === "en") {
            const query = `SELECT start_date,end_date FROM periode WHERE start_date<='${moment().format("YYYY-MM-DD")}' AND end_date>'${moment().format("YYYY-MM-DD")}' AND category=4`;
                ...
                if (err) {
                    ...
                    if (data.length < 1) {
                        winston_1.logger.warn({
                            message: "the quiz event isn't available yet please try another time",
                            API: query
                        });
                        res.send({
                            message: "Sorry the quiz event isn't available yet please try another time",
                            status: 200,
                            success: 1,
                            data: data
                        });
                        ...
                        const query = `SELECT quiz_entries.id quiz_entries_id,quiz_entries.profile_id,quiz_entries.periode,periode.id,periode.start_date,periode.end_date FROM quiz_entries LEFT JOIN periode ON quiz_entries.periode = periode.id WHERE quiz_entries.profile_id = ${verify.id} AND start_date<='${moment().format("YYYY-MM-DD")}' AND periode.end_date>'${moment().format("YYYY-MM-DD")}' AND periode.category=4`;
                        db_1.connection.query(query, (err, data) => {
                            if (err) {
                                winston_1.logger.error({
                                    message: "failed to get data periode",
                    ...
                    if (data.length < 1) {
                        ...
                        db_1.connection.query(query, (err, data) => {
                            if (err) {
                                ...
                                if (data.length < 1) {
                                    const query = `SELECT COUNT(*) as total FROM quiz_questions JOIN periode ON quiz_questions.periode = periode.id WHERE periode.start_date<='${moment().format("YYYY-MM-DD")}' AND periode.end_date>'${moment().format("YYYY-MM-DD")}' AND periode.category=4`;
                                    db_1.connection.query(query, (err, total) => {
                                        if (err) {
                                            winston_1.logger.error({
                                            ...
                                            if (total[0].length < 1) {
                                                ...
                                                const prevPage = currentPage === 1
                                                    ...
                                                    : "https://beta-api.undiundi.id/quiz/questions" +
                                                        "?page=" +
                                                        (currentPage - 1);
                                                const query = `SELECT quiz_questions.id as quisQuestionsId,question FROM quiz_questions JOIN periode ON quiz_questions.periode = periode.id WHERE periode.start_date<='${moment().format("YYYY-MM-DD")}' AND periode.end_date>'${moment().format("YYYY-MM-DD")}' AND periode.category=4 ORDER BY quiz_questions.id ASC LIMIT ${firstData}, ${dataPerPage}`;
                                                db_1.connection.query(query, (err, data) => {
                                                    if (err) {
                                                        winston_1.logger.error({
                                                            message: "error",
                        ...
                        db_1.connection.query(query, (err, data) => {
                            if (err) {
                                ...
                                if (data.length < 1) {
                                    ...
                                    db_1.connection.query(query, (err, total) => {
                                        if (err) {
                                            ...
                                            if (total[0].length < 1) {
                                                ...
                                                res.send({
                                                    message: "tidak menemukan data pertanyaan untuk quiz,, mohon coba dilain waktu",
                                                    status: 404,
                                                    success: 1,
                                                    data: total
                                                });
                                                ...
                                                db_1.connection.query(query, (err, data) => {
                                                    if (err) {
                                                        ...
                                                        if (data.length < 1) {
                                                            ...
                                                            res.send({
                                                                message: "tidak dapat menemukan data pertanyaan untuk quiz,, mohon coba dilain waktu",
                                                                status: 404,
                                                                success: 1,
                                                                data: {
                                                                    dataPerPage: dataPerPage,
                                                            ...
                                                            res.send({
                                                                message: "data questions kuis berhasil di load,, selamat mengerjakan",
                                                                status: 200,
                                                                success: 1,
                                                                data: {
                                                                    dataPerPage: dataPerPage,
                                    ...
                                    res.send({
                                        message: "maaf anda sudah pernah mengisi kuis ini, coba lagi dilain waktu",
                                        status: 200,
                                        success: 1,
                                        data: {}
                                    });
...
exports.quizCorrection = (req, res) => {
    ...
    db_1.connection.query(`SELECT language FROM profiles WHERE id=${verify.id}`, (err, lang) => {
        ...
        if (language === "en") {
            ...
            const query = `SELECT id FROM periode WHERE start_date<='${moment().format("YYYY-MM-DD")}' AND end_date>'${moment().format("YYYY-MM-DD")}' AND category=4`;
            db_1.connection.query(query, (err, data) => {
                if (err) {
                    winston_1.logger.error({
                        ...
                        db_1.connection.query(query, (err, duplicateEntries) => {
                            if (err) {
                                ...
                                if (duplicateEntries.length >= 1) {
                                    ...
                                    const query = `SELECT COUNT(*) AS countQuestions FROM quiz_questions LEFT JOIN periode ON quiz_questions.periode = periode.id WHERE periode.start_date<='${moment().format("YYYY-MM-DD")}' AND periode.end_date>'${moment().format("YYYY-MM-DD")}' AND periode.category=4`;
                                    db_1.connection.query(query, (err, count) => {
                                        if (err) {
                                            ...
                                            if (count[0] < 1) {
                                                ...
                                                const query = `SELECT COUNT(*) AS countAnswer FROM quiz_entries LEFT JOIN periode ON quiz_entries.periode = periode.id WHERE quiz_entries.profile_id = ${verify.id} AND (periode.start_date<='${moment().format("YYYY-MM-DD")}' AND periode.end_date>'${moment().format("YYYY-MM-DD")}') AND periode.category=4`;
                                                db_1.connection.query(query, (err, countEntries) => {
                                                    if (err) {
                                                        winston_1.logger.error({
                                                            message: "error to count data from quiz_entries",
                                                            API: API,
                                                            query: query
                                                        });
                                                        res.send({
                                                        ...
                                                        if (countEntries[0].countAnswer < 1) {
                                                            ...
                                                            if (countQuestions === userAnswer) {
                                                                ...
                                                                db_1.connection.query(query, (err, finalCount) => {
                                                                    if (err) {
                                                                        winston_1.logger.error({
                                                                            message: "error to count data from quiz_entries",
                                                                            API: API,
                                                                        ...
                                                                        if (finalCount[0].rightCount < 1) {
                                                                            ...
                                                                            db_1.connection.query(query, (err, lead) => {
                                                                                if (err) {
                                                                                    ...
                                                                                    if (lead[0] < 1) {
                                                                                        const point = Math.round((finalCount[0]
                                                                                            .rightCount /
                                                                                            countQuestions) *
                                                                                            100);
                                                                                        const query = `INSERT INTO quiz_leaderboard (profile_id,periode,score,createdAt) VALUES(${verify.id},${data[0].id},${point},'${moment().format("YYYY-MM-DD")}')`;
                                                                                        db_1.connection.query(query, (err, quizLeader) => {
                                                                                            if (err) {
                                                                                                winston_1.logger.error({
                                                                                                    message: "error",
                                                                                                    API: API,
